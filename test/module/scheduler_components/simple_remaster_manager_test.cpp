...
TEST_F(SimpleRemasterManagerTest, ValidateMetadata) {
  ...
  auto txn = MakeTestTxnHolder(configs[0], 100, {{"A", 1, 1}}, {});
...
TEST_F(SimpleRemasterManagerTest, CheckCounters) {
  ...
  auto txn2 = MakeTestTxnHolder(configs[0], 200, {{"A", 0, 0}}, {});
  auto txn3 = MakeTestTxnHolder(configs[0], 300, {{"A", 0, 2}}, {});
...
TEST_F(SimpleRemasterManagerTest, CheckMultipleCounters) {
  ...
  auto txn1 = MakeTestTxnHolder(configs[0], 100, {{"A", 0, 1}}, {{"B", 0, 1}});
  auto txn2 = MakeTestTxnHolder(configs[0], 200, {{"A", 0, 0}, {"B", 0, 1}}, {});
  auto txn3 = MakeTestTxnHolder(configs[0], 300, {}, {{"A", 0, 1}, {"B", 0, 2}});
...
TEST_F(SimpleRemasterManagerTest, BlockLocalLog) {
  ...
  auto txn1 = MakeTestTxnHolder(configs[0], 100, {{"A", 0, 2}}, {});
  auto txn2 = MakeTestTxnHolder(configs[0], 200, {{"A", 0, 1}}, {});
  auto txn3 = MakeTestTxnHolder(configs[0], 300, {{"B", 1, 1}}, {});
...
TEST_F(SimpleRemasterManagerTest, ReleaseTransaction) {
  ...
  auto txn1 = MakeTestTxnHolder(configs[0], 100, {{"B", 0, 2}}, {});
  auto txn2 = MakeTestTxnHolder(configs[0], 200, {{"A", 0, 1}}, {});
  auto txn3 = MakeTestTxnHolder(configs[0], 300, {{"A", 0, 1}}, {});
